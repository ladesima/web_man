...
@section('title', 'Media Gambar - Sistem Informasi')
@section('content')
...
<div class="bg-white rounded-2xl p-8" style="box-shadow:0 2px 12px rgba(0,0,0,0.07);">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        @php
        $items = [
            ['name' => 'homepage',      'label' => 'Homepage',       'ukuran' => '1440x791 piksel'],
            ['name' => 'homepage_ppdb1','label' => 'Homepage PPDB 1','ukuran' => '1440x791 piksel'],
            ['name' => 'homepage_ppdb1b','label' => 'Homepage PPDB 1','ukuran' => '1440x791 piksel'],
            ['name' => 'homepage_ppdb2','label' => 'Homepage PPDB 2','ukuran' => '1440x791 piksel'],
            ['name' => 'homepage_ppdb3','label' => 'Homepage PPDB 3','ukuran' => '1440x791 piksel'],
            ['name' => 'sambutan',      'label' => 'Sambutan Kepsek','ukuran' => '1440x651 piksel'],
        ];
        @endphp
