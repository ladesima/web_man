    ...
    <template x-teleport="body">
        <div x-show="showHapus" x-cloak
            ...
            <div @click.outside="showHapus = false"
                ...
                <h2 class="text-[15px] font-bold text-[#2B2A28] mb-2">Hapus Akun?</h2>
                <p class="text-[12px] text-slate-400 mb-6">Akun <span class="font-semibold text-[#2B2A28]" x-text="selectedRow?.nama"></span> akan dihapus permanen.</p>
