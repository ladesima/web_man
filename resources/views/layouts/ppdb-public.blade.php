...
<body class="bg-white text-slate-800 antialiased">
    ...
    <nav class="bg-[#27C2DE] shadow-[0px_4px_4px_rgba(101,101,101,0.25)] sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-4">
            <div class="h-20 flex items-center justify-between">
                ...
                <div class="hidden md:flex items-center gap-7 text-sm text-white font-medium">
                    ...
                    <button onclick="bukaPopupKontak()"
        ...
        <div id="mob-menu" class="hidden md:hidden bg-[#22b0cb] border-t border-white/20 px-4 py-3 space-y-1">
            ...
            <button onclick="bukaPopupKontak()"
                    class="block w-full mt-2 text-center bg-white text-[#27C2DE] py-2 rounded-full text-sm font-semibold">
                Hubungi Kami
            </button>
        </div>
    </nav>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 items-center pt-6">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <div>
                            <h4 class="font-bold text-sm mb-2">Menu Cepat</h4>
    ...
    <script>
        ...
        // Fungsi popup — dipanggil dari landing.blade.php
        function bukaPopupKontak() {
            document.getElementById('popup-kontak').classList.add('active');
            document.body.style.overflow = 'hidden';
        }
        function tutupPopupKontak() {
            document.getElementById('popup-kontak').classList.remove('active');
            document.body.style.overflow = '';
        }
        document.addEventListener('keydown', e => {
            if (e.key === 'Escape') tutupPopupKontak();
        });
    </script>
