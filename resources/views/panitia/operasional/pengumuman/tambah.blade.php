        ...
        <div class="mb-6">
            ...
            <div style="border: 1px solid #DFEAF2; border-radius: 8px; overflow: hidden;">
                ...
                <div class="flex items-center justify-center gap-1 px-3 py-2"
                    ...
                    <button type="button" onclick="document.execCommand('redo')" class="toolbar-btn" style="color:white;">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <button type="button" onclick="document.execCommand('justifyCenter')" class="toolbar-btn" style="color:white;" title="Tengah">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4 6h16M7 12h10M5 18h14"/>
                        </svg>
                    </button>
                    <button type="button" onclick="document.execCommand('justifyRight')" class="toolbar-btn" style="color:white;" title="Kanan">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4 6h16M10 12h10M6 18h14"/>
                        </svg>
                    </button>
                    <button type="button" onclick="document.execCommand('justifyFull')" class="toolbar-btn" style="color:white;" title="Rata kanan-kiri">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
